...
date: 2023-01-02
description: "操作步骤如下： 1、打开开发者工具——设置——编辑器设置"
author: "NickLinus"
category: "微信小程序"
thumbnail: ""
published: true
...
操作步骤如下：
1、打开开发者工具——设置——编辑器设置
 ![在这里插入图片描述](/images/wechat/127_1.png)

2、更多及工作区的编辑器设置
 ![在这里插入图片描述](/images/wechat/127_2.png)

3、点击右上角文件图标
 ![在这里插入图片描述](/images/wechat/127_3.png)

4、setting.json文件配置
 ![在这里插入图片描述](/images/wechat/127_4.png)
